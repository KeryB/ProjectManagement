...
public class UserController {
    ...
    public RestResponse fetchUserData(HttpServletRequest request, @MappedUser User user) {
        UserProjectPermissionDto userProjectPermissionDto = userService.getUserData(user.getId());
        ...
        if (chosenProjectId != null && StringUtils.isNumber(chosenProjectId)) {
            ...
            userProjectPermissionDto.setChosenProject(projectService.findUserProjectByProjectId(projectId, user.getId()));
        }
