...
export const TaskTypeOption = [
    {value: 0, name: 'Баг', displayName:'BUG', avatar: <Avatar size='small' src='/resources/images/bug.png'/>},
...
export const PriorityTask = [
    {value: 0, name: 'Срочный', displayName:'BLOCKER', avatar: <span className='priority-blocker'>Срочный</span>},
    {value: 1, name: 'Главный', displayName:'MAJOR', avatar: <span className='priority-major'>Главный</span>},
    {value: 2, name: 'Критический', displayName:'CRITICAL', avatar:  <span className='priority-critical'>Критический</span>},
    {value: 3, name: 'Незначительный', displayName:'MINOR', avatar:  <span className='priority-minor'>Незначительный</span>}
];
...
export const TaskStatus = [
    {value: 0, name: 'Открытая', displayName:'OPEN', avatar: <Tag color="#3CB371">Открытая</Tag>},
    {value: 1, name: 'Переоткрытая', displayName:'REOPEN', avatar:  <Tag color="#FFA500">Переоткрытая</Tag>},
    {value: 2, name: 'RESOLVED', displayName:'RESOLVED', avatar:  <Avatar size='small' src='/resources/images/critical.png'/>},
    {value: 3, name: 'В разработке', displayName:'IN_PROGRESS', avatar:  <Tag color="#108ee9">В разработке</Tag>},
